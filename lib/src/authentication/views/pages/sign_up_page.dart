        ...
        child: Padding(
          ...
          child: Stack(
            children: [
                  ...
                  FilledButton(
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        await authVm.registerUser(context, email, password, formattedNumber, fullName, address);
                      }
                    },
              ...
              Positioned(left: 0, right: 0, top: 0, bottom: 0, child: Visibility(visible: authVm.registeringUser, child: const Loader()))
            ],
          ),
        ),
      ),
