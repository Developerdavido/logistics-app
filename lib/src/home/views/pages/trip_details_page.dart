...
import 'package:logistics_app/src/home/widgets/contact_receipt.dart';
import 'package:logistics_app/src/home/widgets/view_instruction_and_map.dart';
...
class TripDetailsPage extends StatelessWidget {
  ...
  static const path='/trip_details';
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                children:[
                  ...
                  const SizedBox(height: 20,),
                  CustomizeButton(
                    text: AppStrings.packagePickedUp,
                    onTap: (){
                      Navigator.pushNamed(context, StartTripPage.path);
